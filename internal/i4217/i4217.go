...
func ByCode(c string) (ISO4217, bool) {
	name, found := names[c]
	if !found {
		return ISO4217{}, found
	}

	units, found := minorUnits[c]
	if !found {
		return ISO4217{}, found
	}

	return ISO4217{Units: units, Name: name, Code: c}, found
}

// ByName resolves the given name to the numeric code and the number of minor
// unit digits to display for the given currency.
func ByName(s string) (ISO4217, bool) {
	code, found := codes[s]
	if !found {
		return ISO4217{}, found
	}
